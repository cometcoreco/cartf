...
Route::middleware([
    ...
    // Global search
    Route::get('/global-search', [GeneralSettingsController::class, 'globalSearch'])->name('admin.search.global');
...
-------------------------------------------- */
    ...
    // Unique Checker
    Route::post('unique-checker', [GeneralSettingsController::class, 'unique_checker'])->name('unique-checker');
});
